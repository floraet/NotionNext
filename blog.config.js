...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || 'b6da1ae31a2c4907a288e20398e6b9be',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Floraet', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'cityWalker_Hello_World', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://floraet.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, 记录', // 网站关键词 英文逗号隔开
